...
We can interpret from the regression model for all constituencies in England and Wales, that we can very confident that there is a relationship between the vote share for Reform UK and the vote share for leave. The regression model shows a p-value of approximately 0 for leave vote share. This is statically singficant as it indicates a high degree of confidence that we can reject the null hypothesis and that there is a relationship between Reform and vote leave. The model shows a coefficient of around 0.498 for leave percent, indicating that indicating that for every percent increase in Reform vote share, the leave vote share increases by an average of around 0.498%. We can see this in the plot between the vote leave vote share and Reform vote share as it has a clear positive curve. This positive correlation from the regression model and plot support the hypothesis that areas that had a higher leave vote share have a higher Reform UK vote share.

This relationship also appears in the regression models for each individual region, with all except Wales and Northeast England having p-values of 0 or near 0. Even Wales and Northeast, with p-values of 0.03 and .013 respectively, we can still be very confident that there is a relationship between Reform and leave vote share, albeit with slightly less confidence than the other regions. Like the constituency regression model, the region models are statically significant, showing a similar high degree of confidence that we can reject the null hypothesis and supporting the idea that there is a relationship between Reform and vote leave across all regions. The postive relationship between Reform and vote leave is also apparent across the region plots, with most having a clear postive slope between Reform and leave share.
...
In conclusion, the data supports the hypothesis that there is a positive correlation between Reform UK and leave vote share across English and Welsh constituencies. This relationship is also supported from data in each respective region with the data having a high degree of confidence that there is a positive relationship between Reform and leave vote share. However, from this data, we can't for sure establish a casual relationship between the two as there are many confounding variables that could be affecting the data. Further research on this topic could explore the effect of other variables, such as changes in economic conditions between each election and voter demographic patterns. If I had more resources and time, I would add in data from the 2019 general election to see if there is there any patterns in party vote share and vote leave. Also, I would analyze the other major parties such as the Conservatives and Labour to see if there is a relationship between their vote shares and the Brexit referendum. 


## Apendix

While making this project, I did explore the relationship between vote leave and other parties along with predictions on what their relationship with vote leave would be which you can see below.
