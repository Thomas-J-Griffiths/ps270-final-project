...
During the 2016 Brexit Referendum in the UK, much of the Labour Party leaned towards campaigning for remaining in the EU. However, there was a noticable group of Labour memebrs who campaigned for leaving the EU

Is there a relationship between how people voted in the 2016 Brexit Referendum in the UK and how people voted for the Labour Party in 2024 UK general election? For this question, I hypothesis that constituencies and regions that had a higher vote share for leave in the Brexit Referendum had a higher vote share for the Reform UK and Conservative party in the 2024 general election. Also, the constituencies that had a higher vote share for leave will have a lower vote share for the Liberal Democrats and Greens. Finally, there isn't any significant relationship between leave vote share and the vote share for Labour in the election.
...
The data for this project came from Dr. Henretty, who created a dataset that estimated how each constituency (post-2023 borders) voted in the Brexit referendum. The 2024 general election data came from the House of Commons Library which collecting all the voting data for each constituency by adding up the voting data from each precinct in all respective constituency. The independent variable for this project is the election, specifically between the 2016 referendum and the 2024 general election. The dependent variable is how each constituency voted in each party and in particular the party vote share for Reform UK and the Conservatives. This project will only look at constituencies in England and Wales as the party systems in Scotland and Northern Ireland have significant differences.

The explanatory variable for this project are the constituencies of England and Wales. The outcome variable is the vote share for leave in the Brexit Referendum and Labour vote share in each constituency in the 2024 general election. The hypothesis would be supported if there is a positive correlation between the vote share of leave in the Brexit Referendum and the vote share of Reform UK and the Conservatives in the 2024 general election. It would also be supported if there is a negative correlation between vote share of leave in the referendum and the vote share of the Liberal Democrats in the 2024 election and no meaningful relationship between leave and Labour vote share.
...
Mutiple Regression Model for Other Parties
