...
```{r}
Reform_Con_multreg <- lm(LeavePct ~ Reform_share + Con_share, data = England_results)
...
LD_2019_multreg <- lm(LeavePct ~ LD. + CON., data = England_results_2019)
  tidy(LD_2019_multreg)
```
...
This question is important because the Brexit referendum was a hugely consequential eleciton in the UK and Europe as a whole, begining the process of the UK leaving the European Union. As such, its important to study how voters the voted leave in the referendum voted in subequent elections to get a better understanding of the British electorate and how Brexit could still be affecting British politics.  
