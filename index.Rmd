...
election_results_2019 <- read.csv("data/2019 UK Election Results.csv")
...
```{r}
England_results_2019 <- UK_election_results
```
...
The project's variables are measured using a statistical model The independent variable for this project is the election, specifially between the 2016 referendum and the 2024 general election. The dependent variable is how each constituency voted in each party and in particular the party vote share for Reform UK and the Conservatives.
